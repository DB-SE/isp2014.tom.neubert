...
public aspect Quiz {
	...
	after(String feature):startFeature(feature){
		if(feature.equals("Quiz")){
			...
			System.out.println("3. �Mia san mia� sagen Fans aus... ");
			...
			System.out.println("4. Wieviel Pl�tze hat der Signal Iduna Park? ");
			...
			System.out.println("a) J�rgen Kohler");
			...
			System.out.println("7. Wann wurde der BVB gegr�ndet?");
